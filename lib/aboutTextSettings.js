...
const ABOUT_TEXT_SETTING_KEYS = {
  ...
  teamSectionEnabled: "about_text_team_section_enabled",
  teamSectionTitle: "about_text_team_section_title",
  teamMember1Name: "about_text_team_member_1_name",
  teamMember1Title: "about_text_team_member_1_title",
  teamMember1ImageUrl: "about_text_team_member_1_image_url",
  teamMember2Name: "about_text_team_member_2_name",
  teamMember2Title: "about_text_team_member_2_title",
  teamMember2ImageUrl: "about_text_team_member_2_image_url",
  teamMember3Name: "about_text_team_member_3_name",
  teamMember3Title: "about_text_team_member_3_title",
  teamMember3ImageUrl: "about_text_team_member_3_image_url",
  teamMember4Name: "about_text_team_member_4_name",
  teamMember4Title: "about_text_team_member_4_title",
  teamMember4ImageUrl: "about_text_team_member_4_image_url",
};
...
const ABOUT_TEXT_DEFAULTS = {
  ...
  teamSectionEnabled: "on",
  teamSectionTitle: "Meet the Team",
  teamMember1Name: "A",
  teamMember1Title: "Founder",
  teamMember1ImageUrl: "",
  teamMember2Name: "B",
  teamMember2Title: "Operations",
  teamMember2ImageUrl: "",
  teamMember3Name: "C",
  teamMember3Title: "Marketing",
  teamMember3ImageUrl: "",
  teamMember4Name: "D",
  teamMember4Title: "Community",
  teamMember4ImageUrl: "",
};
const SETTINGS_CACHE_TTL_MS = 60 * 1000;
let cachedAboutTextSettings = null;
let cachedAboutTextLoadedAt = 0;
...
const getAboutTextSettings = async () => {
  if (
    cachedAboutTextSettings &&
    Date.now() - cachedAboutTextLoadedAt < SETTINGS_CACHE_TTL_MS
  ) {
    return cachedAboutTextSettings;
  }
  ...
  try {
    ...
    cachedAboutTextSettings = buildAboutTextSettings(settingsByKey);
    cachedAboutTextLoadedAt = Date.now();
    return cachedAboutTextSettings;
  } catch (error) {
    logger.warn("about_text_settings_load_failed", { error: error.message });
    if (cachedAboutTextSettings) {
      return cachedAboutTextSettings;
    }
...
const saveAboutTextSettings = async (settings = {}) => {
  const current = await getAboutTextSettings();
  const payload = Object.entries(ABOUT_TEXT_SETTING_KEYS).reduce(
    (acc, [field, key]) => {
